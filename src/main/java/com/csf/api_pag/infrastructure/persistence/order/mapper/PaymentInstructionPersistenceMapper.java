...
import com.csf.api_pag.domain.order.valueobject.paymentInstruction.Discount;
import com.csf.api_pag.domain.order.valueobject.paymentInstruction.Fine;
import com.csf.api_pag.domain.order.valueobject.paymentInstruction.Interest;
import com.csf.api_pag.domain.order.valueobject.paymentInstruction.PaymentInstruction;
import com.csf.api_pag.infrastructure.persistence.order.embeddable.DiscountEmbeddableJpa;
import com.csf.api_pag.infrastructure.persistence.order.embeddable.FineEmbeddableJpa;
import com.csf.api_pag.infrastructure.persistence.order.embeddable.InterestEmbeddableJpa;
